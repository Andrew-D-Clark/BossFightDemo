...
void ASAIBoss::PostInitializeComponents()
{
	Super::PostInitializeComponents();

	PawnSensingComp->OnSeePawn.AddDynamic(this, &ASAIBoss::OnPawnSeen);
	AttributeComp->OnHealthChanged.AddDynamic(this, &ASAIBoss::OnHealthChanged);
}
...
void ASAIBoss::SetTargetActor(AActor* NewTarget)
{
	AAIController* AIC = Cast<AAIController>(GetController());
	if (AIC)
	{
...
AActor* ASAIBoss::GetTargetActor() const
{
	AAIController* AIC = Cast<AAIController>(GetController());
	if (AIC)
	{
...
void ASAIBoss::OnPawnSeen(APawn* Pawn)
{
